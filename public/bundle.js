...
module.exports = function(key, secret) {
  ...
  var hash = crypto.createHmac('sha256', secret).update(key + epoch)
    .digest('hex');
  var out = 'A5-API ' + new Buffer(key + ':' + hash + ':' + epoch, 'ascii')
    .toString('base64');
  return out;

};

},{"__browserify_Buffer":11,"crypto":6}],2:[function(require,module,exports){
/*!
...
},{"../../../api/lib/generateHash":1,"../lib/prettyprint.js":4,"jquery":2}],4:[function(require,module,exports){
module.exports =  {
...
},{"./md5":7,"./rng":8,"./sha":9,"./sha256":10,"buffer":12}],7:[function(require,module,exports){
/*
